...
- Name: apps\tests\tests\core\auth-manager.spec.ts >> §16 deleteAuthStorageOnTestRun >> true: removes stale session file content before setup, writes fresh
- Location: apps\tests\tests\core\auth-manager.spec.ts:172:7
