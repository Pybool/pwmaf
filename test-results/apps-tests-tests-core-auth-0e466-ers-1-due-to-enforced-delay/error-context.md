...
- Name: apps\tests\tests\core\auth-manager.spec.ts >> §17 rateLimited — login sequencing >> true: setup takes ≥ 500ms × (users-1) due to enforced delay
- Location: apps\tests\tests\core\auth-manager.spec.ts:251:7
